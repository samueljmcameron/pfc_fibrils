...
if __name__=="__main__":
    ...
    omegas = np.logspace(-2,1,num=100,endpoint=True)
    ...
    if len(sys.argv)<4:
        ...
        omega_float = omegas[int(sys.argv[3])]
        gamma,k24,omega = sys.argv[1],sys.argv[2],str(omega_float)


    Lambdas = np.logspace(-1,3,num=1000,endpoint=True)
