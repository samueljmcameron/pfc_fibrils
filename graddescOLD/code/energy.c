	   ...
	   double integration_2233b,int mpt)
{
  ...
  double E;
  E = 2.0/(R*R)*integration_2233b; // first calculate bulk energy per unit length
...
{
  double integration_2233b,integration1,integration2;

  compute_rf2233b(K33,Lambda,eta,d0,L,r,y,rf_,mpt);
  integration_2233b = qromb(r,rf_,mpt);
  ...
  *E = E_R(R,k24,L,gamma_s,gamma_t,r,y,integration_2233b,mpt);

  *dEdR = derivEdR(R,K33,k24,Lambda,eta,d0,L,gamma_s,r,y,
		   integration_2233b,mpt);
