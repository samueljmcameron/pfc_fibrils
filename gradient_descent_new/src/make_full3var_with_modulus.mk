...
LOCAL_SRC = full3var_driver.c full3var_with_modulus.c utilities.c

ENERGY_SRC := pinvs.c red.c shooting.c bksub.c energy.c nrutil.c polint.c trapzd.c \
              solvde.c difeq.c finite_differences.c qromb.c shared.c modulusintegral.c
