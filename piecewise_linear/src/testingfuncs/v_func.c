...
int main(int argc, char **argv)
{
  ...
  initialize_file(&v_func,argv[1],"v_func",p);
  ...
  for (i = 0; i < num; i++) {
    ...
    fprintf(v_func,"%13.6e\t%13.6e\t%13.6e\t%13.6e\t%13.6e\t%13.6e\n",
	    zeta,vfunc(x_1,x_2,xi,zeta),dvdxi(x_1,x_2,xi,zeta),
	    dvdzeta(x_1,x_2,xi,zeta),dvdx_1(x_1,xi,zeta),
	    dvdx_2(x_2,xi,zeta));
