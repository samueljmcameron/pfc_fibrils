...
int main(int argc, char **argv)
{
  ...
  initialize_file(&g2_func,argv[1],"g2_func",p);
  ...
  for (i = 0; i < num; i++) {
    ...
    fprintf(g2_func,"%13.6e\t%13.6e\t%13.6e\t%13.6e\n",zeta,
	    g_2func(x_1,x_2,xi,zeta),dg_2dxi(x_1,x_2,xi,zeta),
	    dg_2dzeta(x_1,x_2,xi,zeta));
