...
int main(int argc, char **argv)
{
  ...
  initialize_file(&f2_func,argv[1],"f2_func",p);
  ...
  for (i = 0; i < num; i++) {
    ...
    fprintf(f2_func,"%13.6e\t%13.6e\t%13.6e\t%13.6e\n",zeta,
	    f_2func(x_1,x_2,xi,zeta),df_2dxi(x_1,x_2,xi,zeta),
	    df_2dzeta(x_1,x_2,xi,zeta));
