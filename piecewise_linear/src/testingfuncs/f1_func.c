...
int main(int argc, char **argv)
{
  ...
  initialize_file(&test_f1,argv[1],"f1_func",p);
  ...
  for (i = 0; i < num; i++) {
    ...
    fprintf(test_f1,"%13.6e\t%13.6e\t%13.6e\t%13.6e\n",zeta,
	    f_1func(x_1,x_2,xi,zeta),df_1dxi(x_1,x_2,xi,zeta),
	    df_1dzeta(x_1,x_2,xi,zeta));
