...
In order to approximate $\Lambda$, we can look at how our model will respond to a small strain on the periodic spacing (i.e. the d-band), a method that has been applied in determining the bulk modulus of contribution in phase field crystal models \cite{Elder:2004ct}. If I define $\eta=2\pi/d$, with $d$ being the perturbed d-band spacing from it's equilibrium, then expanding our free energy in terms of the applied strain $u=(d-d_0)/d_0$ will provide a dimensionless bulk modulus, $K=1/2\partial^2E/\partial u^2$, from the definition
\begin{equation}\label{eq:strain_taylor}
E(u)=E(0)+\frac{1}{2}\left.\frac{\partial^2E}{\partial u^2}\right|_{u=0}\!\!\!\!\!\!\!\!\!u^2+\mathcal{O}(u^3).
\end{equation}
Inserting the strain eqn \ref{eq:final},
\begin{equation}\label{eq:fe_strain}
\end{equation}
%%%%%%%%%%%%%%%
% Bibliography
%%%%%%%%%%%%%%%
